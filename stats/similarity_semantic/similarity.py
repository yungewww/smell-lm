...
# # Axes
# ax.set_xticks(x)
# ax.set_xticklabels([f'P{p}' for p in data['Participant']], fontsize=16, rotation=45, ha='right')
# ax.set_ylabel('Similarity improvement (Δ)', fontsize=16)
...
# ]
# ax.legend(handles=patches, fontsize=16, frameon=False, loc='upper right')
...
# )
# ax.set_title(stats_text, fontsize=16, color='gray', pad=10)
